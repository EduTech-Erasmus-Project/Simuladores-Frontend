...
export class RegisterComponent implements OnInit {
  ...
  constructor(
    ...
    private informacionEvaluador: InformacionEvaluadorService,
  ...
  recuperarEvaluadores() {
    var nombre: string = "";
    this.informacionEvaluador
      .recuperarEvaluadoresParaRegistro()
      .then((evaluadores) => {
  ...
  validadCorreo() {
    this.autentificacionService
      .checkEmail(this.emailParticipante)
      .subscribe((res) => {
  ...
  crearNuevoParticipante() {
    this.participante = {
      ...
      fechaNacimiento: this.datePipe.transform(
        this.fechaNacimientoParticipante,
        "yyyy-MM-dd"
      ),
    ...
    this.informacionParticipante
      .registrarNuevoParticipante(this.participante)
      .subscribe((res) => {
  ...
  agregarExperiencia() {
    if (
      this.sectorEconomicoParticipante != "" &&
      this.areaLaboralParticipante != "" &&
      this.experienciaAniosParticipante > 0 &&
      this.emailParticipante != ""
    ) {
      this.informacionParticipante
        .registrarExperienciaLaboralParticipante(
          this.sectorEconomicoParticipante,
          this.areaLaboralParticipante,
          this.experienciaAniosParticipante,
          this.emailParticipante
        )
        .subscribe((res) => {
          this.contadorExperienciasAgregadas++;
          this.advertenciaExpeciencia =
            "Se agrego nueva experiencia laboral al participante " +
            this.emailParticipante +
            ", discapacidades del participante: " +
            this.contadorExperienciasAgregadas;
      ...
      this.advertenciaExpeciencia =
        "Por favor la experiencia laboral debe ser mayor a 0";
      this.formularioExperiencia = true;
      this.experienciaCorrectoAlmacenamiento = false;
    }
  }
  ...
  agregarDiscapacidad() {
    if (
      this.seleccionTipoDiscapacidad.value != "" &&
      this.gradoDiscapacidadParticipante > 0 &&
      this.emailParticipante != ""
    ) {
      this.informacionParticipante
        .registrarDiscapacidadParticipante(
          this.seleccionTipoDiscapacidad.value,
          this.gradoDiscapacidadParticipante,
          this.emailParticipante
        )
        .subscribe((res) => {
          this.contadorDiscapacidadesAgregadas++;
          this.advertenciaDiscapacidad =
            "Se agrego nueva discapacidad al participante " +
            this.emailParticipante +
            ", discapacidades del participante: " +
            this.contadorDiscapacidadesAgregadas;
      ...
      this.advertenciaDiscapacidad =
        "Por favor ingrese un tipo de discapacidad";
      ...
      this.advertenciaDiscapacidad =
        "Por favor el grado de discapacidad debe ser mayor a 0";
      this.formularioDiscapacidad = true;
      this.discapacidadCorrectoAlmacenamiento = false;
    }
  }
