...
export class EjercitarioService {
  ...
  obtenerTotalEjercitarios() {
    return this.http.get<any>(environment.WS_PATH + "getTotalEjercitarios/");
  }

  informacionCount() {
    return this.http.get<any>(environment.WS_PATH + "informacionCount/");
  }
  obtenerListaejercitario() {
    return this.http.get<any>(environment.WS_PATH + "listaEjercitario/");
  }
  ...
  registroEjercitario(data: any) {
    ...
    formData.append(
      ...
      data.instruccionPrincipalEjercitario
    );
    formData.append(
      "instruccionesParticipantes",
      data.instruccionesParticipantes
    );
    formData.append("variaciones", data.variaciones);
    return this.http.post(
      environment.WS_PATH + "registroEjercitario/",
      formData,
      {
        reportProgress: true,
        observe: "events",
